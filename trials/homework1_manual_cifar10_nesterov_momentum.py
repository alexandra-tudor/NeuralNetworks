...
# update parameters for the nest iteration
W2 = W2.assign(W2 - learning_rate * mu * grad_W2_momentum)
b2 = b2.assign(b2 - learning_rate * mu * grad_b2_momentum)
...
# update parameters for the nest iteration
W1 = W1.assign(W1 - learning_rate * mu * grad_W1_momentum)
b1 = b1.assign(b1 - learning_rate * mu * grad_b1_momentum)
...
with tf.Session() as sess:
    ...
    print ("Accuracy:", accuracy.eval({x: images_test[:3000], y: labels_test[:3000]}))
    ...
    for epoch in range(training_epochs):
        ...
        for i in range(total_batch):
            batch_xs, batch_ys = random_batch(images_train, labels_train, 3000)
